...
title="Projected PCnumber, title_sea"
...
'draw line 'xfrq' 'y0' 'xfrq' 'y1
'draw string 'xfrq+0.1' 'y1-0.2' 80 day'
  xlog=logzz(0.033)
  xfrq=(xlog-xlg1)/(xlg2-xlg1)*xs+x0
'draw line 'xfrq' 'y0' 'xfrq' 'y1
'draw string 'xfrq+0.1' 'y1-0.2' 30 day'
...
aa = read(sp256.ts0number.var)
bb = sublin(aa,2)
cc = subwrd(bb,1)

'set string 1 r 1 0'
'set strsiz 0.15'
'draw string 'x1-0.5' 'y1-0.5' %Var in 30-80d band :'
'draw string 'x1-0.5' 'y1-0.8' 'cc'% of ExpVar'

* Print file
*'printim 'fname'.gif gif x1100 y850 white'
'printim 'fname'.png x1100 y850 white'
*'disable print'
