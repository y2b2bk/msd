reinit
*
open homedir/level_2/wk99/variable/power/norm.sym.ctl
open homedir/level_2/wk99/variable/power/norm.asy.ctl
*
set xlopts 1 2 0.10
set ylopts 1 2 0.10
*
...
set gxout grfill
*set csmooth on
run homedir/tools/setclevs.gs 0.1 10 1.1
...
set z 3
d er
run homedir/tools/space-time/draw_string2.gs -6.5 0.10 1 0.12 n=1 ER
...
*
run homedir/tools/space-time/draw_string2.gs 5.5 0.04 1 0.12 MJO
close 5
close 4
close 3
...
*
run homedir/tools/space-time/draw_string2.gs 5.5 0.025 1 0.12 MJO
*
...
set string 1 c
set strsiz 0.20
draw string 5.5 8.0 MJO Multi-scale metrics : Wheeler-Kiladis diagram
set string 1 c
set strsiz 0.12
draw string 5.5 7.6 Variable (Data) : title_mjo (title_var), Period : period
draw string 5.5 7.3 96-day segment, 60-day overlapping
*
set string 1 r
set strsiz 0.12
draw string 10.8 0.3 *Reference: Wheeler and Kiladis (1999, JAS)

*printim wk99.variable.gif gif x770 y595 white
printim wk99.variable.png x770 y595 white
