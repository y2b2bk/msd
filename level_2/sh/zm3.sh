...
EOF
 ...
 cp -f $HHH/level_2/com/zm3/zm3.ctl.com .

 sed "s/num_x/$XXX/g"    zm3.ctl.com > tmp1
 ...
 sed "s/zm/15S15N/g"               tmp1 > tmp2
 sed "s/missing/$MMM/g"            tmp2 > tmp1
 sed "s/period/$PPP/g"             tmp1 > tmp2
 sed "s/daily/daily.anom/g"        tmp2 > daily.anom.15S15N.$PPP.ctl
 ...
 sed "s/missing/$MMM/g"            tmp2 > tmp1
 sed "s/period/$PPP/g"             tmp1 > tmp2
 sed "s/daily/daily.filt.20-100.lanz.100/g"      tmp2 > daily.filt.20-100.lanz.100.15S15N.$PPP.ctl
